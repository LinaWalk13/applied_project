...
library(knitr)
library(kableExtra)
pacman::p_load(magick, jtools)

# Create a linear model
model <- lm(rating ~ slides, data = data)
...
coefficients_table <- kable(coefficients_df, "html", align = "c") %>%
  kable_styling(full_width = F, position = "center", 
                bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
                font_size = 16)

# Export the table as a picture
save_kable(coefficients_table,file = "coefficients_table.png")
